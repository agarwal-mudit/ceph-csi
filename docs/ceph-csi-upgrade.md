...
- [Ceph-csi Upgrade](#ceph-csi-upgrade)
  ...
  - [Upgrading from v3.1 to v3.2](#upgrading-from-v31-to-v32)
    ...
    - [CSI Sidecar containers considerations](#csi-sidecar-containers-considerations)
...
Refer [upgrade-from-v3.0-v3.1](https://github.com/ceph/ceph-csi/blob/v3.1.0/docs/ceph-csi-upgrade.md)
...
With 3.2.0 version of ceph-csi we have updated the versions of CSI sidecar containers. These versions are generally compatible with kubernetes version>=1.17 but based on the kubernetes version you are using, you need to update the templates with required sidecar versions. You also might need to update or remove a few arguments based on the sidecar versions you are using.
Here is a table for your refernce:


| Sidecar container | Updated version | Minimum Kubernetes version |
| -------- | -------- | -------- |
| csi-attacher     | 3.0.2     | v1.17     |
| csi-snapshotter     | 3.0.2     | v1.17     |
| csi-provisioner     | 2.0.4     | v1.17     |
| csi-node-driver-registrar     | 2.0.1     | v1.17     |
| csi-resizer     | 1.0.1     | v1.17     |
